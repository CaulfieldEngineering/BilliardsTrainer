...
class SettingsPage(QWidget):
    ...
    def _appearance_card(self) -> Card:
        ...
        self._feed_stats = QCheckBox("Feed stats chip (resolution/fps) on the camera view")
        form.addRow("", self._feed_stats)
    ...
    def _load_from_settings(self) -> None:
        ...
        self._feed_stats.setChecked(bool(getattr(s.ui, 'feed_stats', True)))
    ...
    def _save(self) -> None:
        ...
        s.ui.feed_stats = self._feed_stats.isChecked()
